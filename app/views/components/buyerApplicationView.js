          ...
          <Card containerStyle={styles.cardContentContainer}>
            ...
            <View style={[styles.cardContainer, { paddingBottom: 5 }]}>
              <View>
                ...
                <View style={{paddingLeft: 5}}>
                  <Text numberOfLines={1} style={styles.contentText}>{item.buyerName}</Text>
                  <Text numberOfLines={1} style={styles.contentText}>{item.buyerNumber}</Text>
                  <Text numberOfLines={1} style={styles.contentText}>{item.buyerEmail}</Text>
            ...
            <Card containerStyle={styles.cardContentContainer}>
              ...
              <View style={{ paddingBottom: 20 }}>
                ...
                <Text numberOfLines={1} style={styles.contentText}>{item.buyerWhyWantPet}</Text>
              </View>

              <View style={{ paddingBottom: 20 }}>
                <Text style={styles.contentTextBold}>What characteristics are most desirable in a pet for you?</Text>
                <Text numberOfLines={1} style={styles.contentText}>{item.buyerMostDesirableTraits}</Text>
              </View>

              <View style={{ paddingBottom: 20 }}>
                <Text style={styles.contentTextBold}>What characteristics are least desirable in a pet for you?</Text>
                <Text numberOfLines={1} style={styles.contentText}>{item.buyerLeastDesirableTraits}</Text>
              </View>

              <View style={{ paddingBottom: 5 }}>
                <Text style={styles.contentTextBold}>Name(s), breed(s), gender(s) and age(s) of current pets (if applicable)</Text>
                <Text numberOfLines={1} style={styles.contentText}>{item.buyerPreviousPets}</Text>
              </View>
            </Card>
            ...
            <Card containerStyle={styles.cardContentContainer}>
              ...
              <View style={{ paddingBottom: 5 }}>
                ...
                <Text numberOfLines={1} style={styles.contentText}>{item.buyerHouseEnviroment}</Text>
              </View>
            </Card>
